...
const page = usePage();
const form = useForm({
    name: page.props.value.section.name
});

const updateSection = () => {
    const sectionId = page.props.value.section.id;
    Inertia.patch(route("sections.update",sectionId), { name: form.name }, {
...
<template>
    <DashboardLayout>
        ...
        <header class="mb-8">
            <h2 class="font-medium uppercase text-2xl">Edit Section</h2>            
        </header>
