    ...
    <div class="relative">
      ...
      >
        <svg
          ...
          class="feather feather-shopping-bag flex-none text-zinc-600 w-[18px] h-[18px]"
        >
        ...
        >
                      ...
                      <form @submit.prevent="decrease(product.id)">
                        <button
                          ...
                          :class="
                            processing
                              ? 'bg-zinc-300'
                              : 'bg-zinc-300 hover:bg-c-green-300 hover:text-white'
                          "
          ...
          <footer v-if="$page.props.cart.length > 0" class="p-4">
            ...
            >
              ...
              <svg
                v-else
                class="animate-spin-fast w-[16px] h-[16px] text-white"
                fill="currentColor"
                version="1.1"
                id="Layer_1"
                xmlns="http://www.w3.org/2000/svg"
